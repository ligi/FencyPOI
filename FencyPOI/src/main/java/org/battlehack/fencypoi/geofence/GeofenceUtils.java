...
public final class GeofenceUtils {
    ...
    public static final String ACTION_CONNECTION_ERROR =
            "org.battlehack.fencypoi.geofence.ACTION_CONNECTION_ERROR";

    public static final String ACTION_CONNECTION_SUCCESS =
            "org.battlehack.fencypoi.geofence.ACTION_CONNECTION_SUCCESS";

    public static final String ACTION_GEOFENCES_ADDED =
            "org.battlehack.fencypoi.geofence.ACTION_GEOFENCES_ADDED";

    public static final String ACTION_GEOFENCES_REMOVED =
            "org.battlehack.fencypoi.geofence.ACTION_GEOFENCES_DELETED";

    public static final String ACTION_GEOFENCE_ERROR =
            "org.battlehack.fencypoi.geofence.ACTION_GEOFENCES_ERROR";

    public static final String ACTION_GEOFENCE_TRANSITION =
            "org.battlehack.fencypoi.geofence.ACTION_GEOFENCE_TRANSITION";

    public static final String ACTION_GEOFENCE_TRANSITION_ERROR =
                    "org.battlehack.fencypoi.geofence.ACTION_GEOFENCE_TRANSITION_ERROR";

    // The Intent category used by all Location Services sample apps
    public static final String CATEGORY_LOCATION_SERVICES =
                    "org.battlehack.fencypoi.geofence.CATEGORY_LOCATION_SERVICES";
    ...
    public static final String EXTRA_CONNECTION_ERROR_CODE =
            "org.battlehack.fencypoi.geofence.EXTRA_CONNECTION_ERROR_CODE";

    public static final String EXTRA_CONNECTION_ERROR_MESSAGE =
            "org.battlehack.fencypoi.geofence.EXTRA_CONNECTION_ERROR_MESSAGE";

    public static final String EXTRA_GEOFENCE_STATUS =
            "org.battlehack.fencypoi.geofence.EXTRA_GEOFENCE_STATUS";

    /*
     * Keys for flattened geofences stored in SharedPreferences
     */
    public static final String KEY_LATITUDE = "org.battlehack.fencypoi.geofence.KEY_LATITUDE";

    public static final String KEY_LONGITUDE = "org.battlehack.fencypoi.geofence.KEY_LONGITUDE";

    public static final String KEY_RADIUS = "org.battlehack.fencypoi.geofence.KEY_RADIUS";

    public static final String KEY_EXPIRATION_DURATION =
            "org.battlehack.fencypoi.geofence.KEY_EXPIRATION_DURATION";

    public static final String KEY_TRANSITION_TYPE =
            "org.battlehack.fencypoi.geofence.KEY_TRANSITION_TYPE";

    // The prefix for flattened geofence keys
    public static final String KEY_PREFIX =
            "org.battlehack.fencypoi.geofence.KEY";
